  ...
  return (
    <div className="main flex">
      ...
      <div
        ...
        } lg:block s:w-[50%] s:h-[100%] md:w-[25%] md:h-[100vh]  z-40  s:bg-gray-200 lg:bg-white h-screen s:break-words lg:w-[20%] xl2:w-[17%]`}
      >
        <ul className="flex flex-col gap-y-5 pt-28 pl-6 ">
          ...
          <li className="flex items-center gap-x-2 break-words xl2:mt-[500px]  ">
           <p>&larr; Logout</p>
          </li>
        </ul>
      </div>
