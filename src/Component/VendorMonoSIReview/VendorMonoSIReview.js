            ...
            <div className="Details">
              ...
              <div className="fourth-column  md:m-14 s:m-2">
                <div className=" md:ml-3  s:mt-5 md:mt-3 s:mb-3">
                  ...
                  <div className="flex items-center md:mt-8 s:mt-1 s:ml-10 xl2:ml-16 md:ml-14 lg:ml-12 mb-4 s:w-[70%] md:w-[100%] ">
                    <svg
                    ...
                    <p className="md:ms-1 s:text-[8px] md:text-[12px] lg:text-[1rem] font-medium s:ml-1 md:ml-3">
                      4
                    </p>
                    <p className="md:ms-1 s:text-[8px] md:text-[12px] lg:text-[1rem] font-medium s:ml-1">
                      out of
                    </p>
                    <p className="md:ms-1 s:text-[8px] md:text-[12px] lg:text-[1rem] font-medium s:ml-1">
                      5
                    </p>
                    <p className="s:text-[8px] md:text-[12px] lg:text-[1rem] s:mt-6 md:mt-auto xl2:ml-40 lg:ml-14 s:ml-2">
                      200021 global likes
                    </p>
                  </div>
              ...
              <div className="sixth-section md:m-14 s:m-2 ">
                <p className="md:text-lg font-semibold s:text-[12px]  md:text-[14px]   xl2:text-xl mb-10 flex gap-11">
                  ...
                  <p className=" hover:border-b-2  border-black hover:border-black cursor-pointer">
                    Rating
                  </p>
                </p>
                ...
                <div className="max-h-[40%]  w-[100%] overflow-y-auto s:text-[12px]  md:text-sm ">
                  <div className="sm:flex  bg-gray-100 mt-3 p-5 ">
                    <div className="md:w-16 md:h-16 s:w-[20%] rounded s:mx-auto md:mx-0">
                      <img
                    ...
                    <div className=" md:ml-8 sm:ml-2 s:mt-5 sm:mt-2 md:-0 ">
                      <div className="sm:flex ">
                        <p className="text-[#233965] font-semibold ">
                          Dhanajaysagar145@gmail.com
                        </p>{" "}
                        <span className="md:ml-4 sm:ml-2">10 days ago</span>
                      </div>
                      <p className="md:mt-2 s:mt-1 ">
                      <div className="flex items-center  s:mt-1   mb-4 s:w-[70%] md:w-[100%] ">
                    <svg
                      className="md:w-4 md:h-4 xl2:w-7 xl2:h-7 s:w-6 s:h-6 text-yellow-300 me-1"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <svg
                      className="md:w-4 md:h-4 xl2:w-7 xl2:h-7 s:w-6 s:h-6 text-gray-300 me-1"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 22 20"
              ...
              <form action="">
                <div className="md:p-14 sm:ml-5 md:ml-0 s:p-5 w-[100%]">
                  <div class="flex">

                  <div className="flex items-center mb-4  mt-1  ">
                    <svg
                      className="md:w-8 md:h-8  s:w-6 s:h-6 text-gray-300 me-1 "
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 22 20"
                    ...
                    <button className="md:p-2.5 s:p-2 ml-10 h-full md:w-[15%]  text-sm font-medium text-white bg-blue-700 rounded-sm border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                      Submit
                    </button>
                  </div>
                </div>
