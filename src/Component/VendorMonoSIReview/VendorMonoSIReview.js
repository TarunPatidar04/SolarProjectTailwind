...
import nav1 from "../VendorMonoSIReview/Images/nav1.png";
import nav2 from "../VendorMonoSIReview/Images/nav2.png";
import nav3 from "../VendorMonoSIReview/Images/nav3.png";
import nav4 from "../VendorMonoSIReview/Images/nav4.png";
import nav5 from "../VendorMonoSIReview/Images/nav5.png";
import nav6 from "../VendorMonoSIReview/Images/nav6.png";
import nav7 from "../VendorMonoSIReview/Images/nav7.png";
import Solar1 from "../VendorMonoSIReview/Images/Solar1.png";
import Solar2 from "../VendorMonoSIReview/Images/Solar2.png";
import Solar3 from "../VendorMonoSIReview/Images/Solar3.png";
import Solar4 from "../VendorMonoSIReview/Images/Solar4.png";
import Warranty from "../VendorMonoSIReview/Images/warranty.png";
import Protection from "../VendorMonoSIReview/Images/Protection.png";
import Person from "../VendorMonoSIReview/Images/Person.png";
import Money from "../VendorMonoSIReview/Images/money.png";
import Original from "../VendorMonoSIReview/Images/Original.png";

export default function VendorMonoSIReview() {
  return (
            ...
            <div className="Details">
              ...
              <div className="fourth-column m-14">
                <div className=" md:ml-3 s:ml-5 s:mt-5 md:mt-3 s:mb-3">
                  <p className=" md:text-lg font-semibold s:text-2xl xl2:text-2xl justify-between">
                    <p>Likes</p>
              ...
              <form action="">
                <div className="p-14">
                  ...
                  <div className="flex items-center space-x-1 ">
                    ...
                    <button className="p-2.5 ml-10 h-full w-[150px] text-sm font-medium text-white bg-blue-700 rounded-sm border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                     Submit
                    </button>
                  </div>
                </div>
